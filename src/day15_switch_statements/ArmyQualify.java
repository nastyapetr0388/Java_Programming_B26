...
public class ArmyQualify {
    ...
    /*
    Declare and assign these variables: Citizenship(boolean),
    resident (boolean), and has high school diploma (boolean),
    and age(int). Determine if the person is qualified to join
    the army.
            ...
            > If all the criteria is met print: You are
     */
    public static void main(String[] args) {
        ...
        if((isCitizen || hasDiploma) && hasDiploma && (age >= 18 && age <=35)) {
