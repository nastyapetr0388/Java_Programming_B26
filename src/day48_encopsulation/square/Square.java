package day48_encopsulation.square;
    ...
    */
    ...
    /*
        ...
        - encapsulate the Square class
            ...
            - setter condition: side must be a positive number otherwise it will not be assigned to the instance variabl
    ...
    public String toString(){
        return "Side of Square: " + side + " | Area: " + calculateArea() + " | Perimeter: " + calculatePerimetr();
    }
